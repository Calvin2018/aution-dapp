...
public class Json {
  ...
  public <T> T deserialize(String body, Type returnType) {
    if (returnType == null) throw new IllegalArgumentException("Argument returnType is required.");
    try {
      if (isLenientOnJson) {
        JsonReader jsonReader = new JsonReader(new StringReader(body));
        // see https://google-gson.googlecode.com/svn/trunk/gson/docs/javadocs/com/google/gson/
        // stream/JsonReader.html#setLenient(boolean)
